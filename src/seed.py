...
SEED_POINTS = [
    {"qr_code": "PT-A03", "name": "A 楼快递点", "location": "教学区 A 楼东侧", "gps": "32.05,118.78"},
    {"qr_code": "PT-B07", "name": "B 区菜鸟驿站", "location": "宿舍 B 区门口",  "gps": "32.06,118.79"},
    {"qr_code": "PT-C01", "name": "C 食堂回收点", "location": "中央食堂南门",   "gps": "32.05,118.80"},
]
